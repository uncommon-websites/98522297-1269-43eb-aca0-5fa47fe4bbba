		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-20">
			...
			<div>
				...
				<ul class="space-y-2 text-xs font-mono text-muted">
					<li><a href="mailto:support@plaid.com" class="hover:text-foreground">support@plaid.com</a></li>
				</ul>
			</div>
			...
			<div>
				...
				<ul class="space-y-2 text-xs font-mono text-muted">
					<li><a href="#" class="hover:text-foreground">Payment Initiation</a></li>
					<li><a href="#" class="hover:text-foreground">Transactions</a></li>
					<li><a href="#" class="hover:text-foreground">Auth</a></li>
					<li><a href="#" class="hover:text-foreground">Balance</a></li>
					<li><a href="#" class="hover:text-foreground">Identity</a></li>
					<li><a href="#" class="hover:text-foreground">Assets</a></li>
				</ul>
			</div>
			...
			<!-- Info -->
			<div>
				<h4 class="font-mono text-xs uppercase text-muted mb-4">Compliance</h4>
				<ul class="space-y-2 text-xs font-mono text-muted mb-8">
					...
					<li><a href="#" class="hover:text-foreground">Open Banking</a></li>
					<li><a href="#" class="hover:text-foreground">PSD2 Compliance</a></li>
				</ul>
				
				<!-- Compliance Badges -->
				<div class="flex gap-2">
					<div class="w-12 h-12 border border-border rounded flex items-center justify-center text-[7px] font-bold text-center leading-tight">
						OPEN<br>BANKING
					</div>
					<div class="w-12 h-12 border border-border rounded flex items-center justify-center text-[7px] font-bold text-center leading-tight">
						PSD2
